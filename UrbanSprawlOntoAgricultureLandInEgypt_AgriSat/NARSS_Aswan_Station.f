...
Name        NARSS_Aswan_Station

	BEGIN CentroidPosition

		CentralBody            Earth
		DisplayCoords          Geodetic
		EcfLatitude            2.40700000000000e+01
		EcfLongitude           3.29100000000000e+01
		EcfAltitude            1.45995262786196e+02
		HeightAboveGround      0.00000000000000e+00
		ComputeTrnMaskAsNeeded Off
		AzElMask               AzElMaskFile: NARSS_Aswan_Station.aem
...
BEGIN Extensions
    ...
    BEGIN AccessConstraints
		...
		ElevationAngle		Min  0.0000000000e+00   IncludeIntervals 
    ...
    BEGIN Desc
    Begin LongText
Name:           NARSS Aswan Station
Country:        Egypt
Location:       Aswan
Status:         Active
Type:           GroundStation
Notes:          Approximate location.
Sources:                       http://www.narss.sci.eg/Capabilities.aspx#Capability37
