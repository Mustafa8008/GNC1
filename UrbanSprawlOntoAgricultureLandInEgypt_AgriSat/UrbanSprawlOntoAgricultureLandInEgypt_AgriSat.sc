...
BEGIN Scenario
    Name            UrbanSprawlOntoAgricultureLandInEgypt_AgriSat

BEGIN Epoch

    Epoch        6 Mar 2026 10:00:00.000000000
    SmartEpoch
	BEGIN	EVENT
			Epoch	6 Mar 2026 10:00:00.000000000
			EventEpoch
...
Start                   6 Mar 2026 10:00:00.000000000
Stop                    15 Apr 2026 11:44:28.000000000
    SmartInterval
	BEGIN	EVENTINTERVAL
			BEGIN Interval
				Start	6 Mar 2026 10:00:00.000000000
...
BEGIN Extensions
	...
	BEGIN	EVENTINTERVAL
			BEGIN Interval
				Start	6 Mar 2026 10:00:00.000000000
				Stop	7 Mar 2026 10:00:00.000000000
			END Interval
			IntervalState	Explicit
	END	EVENTINTERVAL
...
BEGIN Animation
    ...
    StartTime          6 Mar 2026 10:00:00.000000000
    EndTime            15 Apr 2026 11:44:28.000000000
    CurrentTime        6 Mar 2026 10:00:00.000000000
    Direction          Forward
    UpdateDelta        3.000000
    RefreshDelta       0.010000
    XRealTimeMult      0.500000
...
BEGIN MapData
    ...
    BEGIN Map
        ...
        BEGIN MapAttributes
            PrimaryBody          Earth
            SecondaryBody        Sun
            CenterLatitude       27.436070
            CenterLongitude      33.698365
            ...
            BEGIN ZoomLocations
                ...
                BEGIN ZoomLocation
                    ...
                    CenterLon    30.538589
                    ZoomWidth    81.021898
                    ZoomHeight   69.635036
                End ZoomLocation
                BEGIN ZoomLocation
                    CenterLat    27.436070
                    CenterLon    33.698365
                    ZoomWidth    16.310452
                    ZoomHeight   15.953289
                End ZoomLocation
            END ZoomLocations
...
BEGIN References
    ...
    END Instance
    Instance Facility/NARSS_Aswan_Station
        Facility/NARSS_Aswan_Station
        Facility/NARSS_Aswan_Station/Sensor/NRF24L01_WirlessTransceiver
        Satellite/AgriSat
    END Instance
    Instance Facility/NARSS_Aswan_Station/Sensor/NRF24L01_WirlessTransceiver
        Facility/NARSS_Aswan_Station/Sensor/NRF24L01_WirlessTransceiver
    END Instance
    Instance LaunchVehicle/Falocn9_Launcher
        LaunchVehicle/Falocn9_Launcher
    END Instance
    Instance Satellite/AgriSat
        Satellite/AgriSat
        Satellite/AgriSat/Sensor/ESP32_CAM
        Satellite/AgriSat/Transmitter/NRF24L01_WirlessTransceiver
    END Instance
    Instance Satellite/AgriSat/Sensor/ESP32_CAM
        CoverageDefinition/CoverageDefinition1
        Satellite/AgriSat/Sensor/ESP32_CAM
    END Instance
    Instance Satellite/AgriSat/Transmitter/NRF24L01_WirlessTransceiver
        Satellite/AgriSat/Transmitter/NRF24L01_WirlessTransceiver
    END Instance
END References
